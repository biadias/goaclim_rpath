...
Here we are working with the Rpath_fitting subtree, for functions and objects related to fitting Rpath models to data. 
...
Specify the prefix local directory into which you want to pull the subtree
Specify the remote repository URL [of the subtree being pulled in]
Specify the remote branch [of the subtree being pulled in]
Specify you want to squash all the remote repository's [the subtree's] logs
...
https://docs.acquia.com/articles/using-git-subtrees-instead-git-submodules
