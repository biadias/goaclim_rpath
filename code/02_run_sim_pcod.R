...
scene_persist_pcod_f0g <- F_clim_sim_scene(scene = scene_bioen_best,
                                       ssp = "persist",
                                       cons = TRUE,resp = TRUE,buf = FALSE,
                                       pcod_rec= TRUE,
                                       pcod_rec_method= "gaussian",
                                       bioen_sp = bioen_sp,
                                       tdc_hind = tdc_hind,
                                       tdr_hind = tdr_hind,
...
forecast_persist_pcod_f0g    <- rsim.run(scene_persist_pcod_f0g, method = "AB", years = all_years)
...
list_persist <- list(
  ...
  "F0 w/ Pcod Rec persg"    = forecast_persist_pcod_f0g,
